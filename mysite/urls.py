...
urlpatterns = [
    ...
    path('servfolio/<str:username>/services/', ServiceView.as_view(), name='service_user' ),
    ...
    path('servfolio/<str:username>/', PortfolioView.as_view(), name='portfolio'),
    path('servfolio/create/', PortfolioCreateView.as_view(), name='portfolio_create'),
    path('servfolio/<str:username>/service/<int:pk>/projects/', ProjectListView.as_view(), name='project' ),
